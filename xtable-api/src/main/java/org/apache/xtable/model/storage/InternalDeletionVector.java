...
public class InternalDeletionVector extends InternalFile {
  ...
  // Unique id to represent Deletion Vector
  @NonNull String id;

  // path (absolute with scheme) of data to which this deletion vector belongs
  ...
  /**
   * Supplier for an iterator that returns the ordinals of records deleted y this deletion vector in
   * teh linked data file, identified by {@link #dataFilePath}.
   *
